...
public class StaticValues {
    ...
    public static final String KEY = "k4y4b4ng3tg1tuhh";
    public static String URL_BASE = "https://freebitco.in/";
    public static String URL_HOME = "https://freebitco.in/?op=home";
