...
public class ProfileView implements Serializable {
    ...
    public String depositAdress;
    public NoCaptchaSpec noCaptchaSpec;
    ...
    private String getDepositAddress(Document doc) {
        Element element = doc.getElementById("main_deposit_address");
        String address = element.val();
        return address;
    }
